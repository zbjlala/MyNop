...
namespace Nop.Core.Infrastructure
{
    ...
    ///研究了某些模式和可选的程序集列表
    ///被<see cref=" assembly ynames "/>引用的程序总是被研究。
    /// </summary>
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets whether Nop should iterate assemblies in the app domain when loading Nop types. Loading patterns are applied when loading these assemblies.
        /// 获取或设置加载Nop类型时Nop是否应迭代应用程序域中的程序集。加载这些程序集时应用加载模式
        /// </summary>
        public bool LoadAppDomainAssemblies { get; set; } = true;

        /// <summary>Gets or sets assemblies loaded a startup in addition to those loaded in the AppDomain.
        /// 获取或设置在AppDomain中加载的程序集之外加载的启动程序集
        /// </summary>
        ...
        /// 获取或设置将被研究的dll模式。为了便于使用，除了为了提高性能，您可能需要配置一个包含程序集和您自己的程序集的模式
        /// </summary>
